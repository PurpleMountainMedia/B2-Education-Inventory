                    ...
                    "el-form-item",
                    {
                      attrs: {
                        ...
                        rules: [
                          {
                            required: true,
                            message: _vm.__("repeatEvery_required")
                          }
                        ],
                        error: _vm.formErrors.repeatEvery,
                        prop: "repeatEvery"
                      }
                    },
                    [
                      _c("el-input-number", {
                        ...
                        model: {
                          value: _vm.form.repeatEvery,
                          callback: function($$v) {
                            _vm.$set(_vm.form, "repeatEvery", $$v)
                          },
                          expression: "form.repeatEvery"
                        }
                      }),
                      _vm._v(" "),
                      _c(
                        ...
                        {
                          model: {
                            value: _vm.form.repeatEveryUnit,
                            callback: function($$v) {
                              _vm.$set(_vm.form, "repeatEveryUnit", $$v)
                            },
                            expression: "form.repeatEveryUnit"
                          }
                        },
